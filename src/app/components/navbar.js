    ...
    return (
        ...
        >
            <div id="brand" className="flex items-center space-x-2 mx-4">
                ...
                <h1 className="md:text-xl font-serif font-semibold tracking-wide text-white">
                    Mariposas Therapy Services

                </h1>
            </div>

            <ul id="nav-links" className="hidden md:flex justify-center space-x-8 text-md font-serif font-bold text-white">
